...
import { clearMapMarkers, setMapType, setSavedLists } from '../../store/mapInfo/MapInfo';


const Home = () => {
	const navigate = useNavigate();
	const savedLists = useSelector((state) => state.mapInfo.savedLists);
	...
	const loadData = async () => {
      ...
      dispatch(setSavedLists(formattedSavedLists));  
    };
